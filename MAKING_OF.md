...
## Coding Details (as of 2025-11-30)

This project is far from perfect and many code sections need polishing.  But it works :smile:

Total Lines of Code: 51,048 generated by AI only.


Breakdown by File Type:

- Java Source Code: 43,833 lines (156 files)
- Java Test Code: 1,640 lines (13 files)
- Generated Java Code: 1,299 lines (1 file - _HarbourLexer.java)
- Harbour Code: 3,121 lines (3 files - debug handlers, error monitors)
- XML Files: 970 lines (65 files - plugin config, project settings)
